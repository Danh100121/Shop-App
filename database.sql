...
-- expiration_date: ngày hết hạn của token
CREATE TABLE tokens(
    id INT PRIMARY KEY AUTO_INCREMENT,
...
ALTER TABLE orders ADD COLUMN shipping_address VARCHAR(100) COMMENT 'địa chỉ ship đến';
ALTER TABLE orders ADD COLUMN shipping_date VARCHAR(100) COMMENT 'ngày nhận hàng';
ALTER TABLE orders ADD COLUMN tracking_number VARCHAR(100) COMMENT 'số vận đơn';
...
-- Trạng thái đơn hàng chỉ được nhận một trong số giá trị cụ thể 
ALTER TABLE orders
